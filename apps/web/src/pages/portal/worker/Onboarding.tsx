...
import type { WorkerOnboardingSummaryItem } from "./types";

export default function WorkerOnboardingPage() {
  const { data, isLoading } = useQuery({
    queryKey: ["portal-worker-onboarding"],
    queryFn: () => apiFetch<WorkerOnboardingSummaryItem[]>("/portal/worker/onboarding"),
  });

...
| **Plan recomendado (agencia chica)** | `starter` (backups diarios incluidos, 7 días retención) | `starter` | Static — Render no cobra plan por sitios estáticos (banda ancha incluida en el free tier de Static Sites) | Static — ídem |
